#Decompiled by MR.MONEY && MR.HMEI24
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://api.whatsapp.com/send?phone=6281413361243&text=Lu%20ganteng%20banget%20bang')
                time.sleep(2)
                menu()
